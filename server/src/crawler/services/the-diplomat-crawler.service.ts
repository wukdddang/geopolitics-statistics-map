...
@Injectable()
export class TheDiplomatCrawlerService {
  private readonly logger = new Logger(TheDiplomatCrawlerService.name);

  async crawlTheDiplomat(browser: Browser): Promise<NewsArticleInfo[]> {
